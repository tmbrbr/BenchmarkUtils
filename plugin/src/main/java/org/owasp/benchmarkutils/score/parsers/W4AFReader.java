...
public class W4AFReader extends Reader {

    @Override
    public boolean canRead(ResultFile resultFile) {
        return resultFile.filename().endsWith(".xml") && resultFile.line(1).startsWith("<w4af-run");
    }
    ...
    public TestSuiteResults parse(ResultFile resultFile) throws Exception {
        ...
        TestSuiteResults tr = new TestSuiteResults("W4AF", false, TestSuiteResults.ToolType.DAST);
    ...
    private String parseVersion(Node root) {
        Node versionNode = getNamedChild("w4af-version", root);
